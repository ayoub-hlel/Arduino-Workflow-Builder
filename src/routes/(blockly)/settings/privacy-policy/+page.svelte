<svelte:head>
  <title>Arduino Workflow Builder - Privacy Policy</title>
</svelte:head>

<div class="row">
  <div class="col">
    <h1>Privacy Policy for Arduino Workflow Builder</h1>

    <p>
      At Arduino Workflow Builder, accessible from https://arduino-workflow-builder.org, one of our
      main priorities is the privacy of our visitors. This Privacy Policy
      document contains types of information that is collected and recorded by
      Arduino Workflow Builder and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Arduino Workflow Builder. This policy is not applicable to any
    ...
    <p>
      Arduino Workflow Builder follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, Arduino Workflow Builder uses 'cookies'. These cookies are
    ...
    <p>
      ...
      advertising partners of Arduino Workflow Builder.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Arduino Workflow Builder, which are sent
    ...
    <p>
      Note that Arduino Workflow Builder has no access to or control over these cookies
    ...
    <p>
      Arduino Workflow Builder's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Arduino Workflow Builder does not knowingly collect any Personal Identifiable
